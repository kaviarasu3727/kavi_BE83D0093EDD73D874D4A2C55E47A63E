...
students1 = [Student("Mourish", "19CS001", 9.5), Student("Rahul", "19CS002", 8.7), Student("Pradhap", "19CS003", 7.8)]
students2 = [Student("Deepan", "19CS004", 8.9), Student("Madhu", "19CS005", 9.2), Student("pavithran", "19CS006", 8.4)]
students3 = [Student("ajay", "19CS007", 9.1), Student("pradhap", "19CS008", 7.6), Student("kaviarasu", "19CS009", 8.2)]
